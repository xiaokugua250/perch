        ...
        <div class="columns">
          ...
          <div class="column is-9">
            <div class="content is-medium">
              ...
              <div class="box">
                <h4 id="basic_user" class="title is-3">用户信息(AuthUser)</h4>
...
{{ props.row.gender }}
              ...
              <div class="box">
                <h4 id="basic_roles" class="title is-3">角色信息(AuthRoles)</h4>
                <article class="message is-primary">
                  <span class="icon has-text-primary">
                  <i class="fab fa-js"></i>
                  </span>
...
{{ props.row.gender }}
              ...
              <div class="box">
                <h4 id="basic_permission" class="title is-3">权限信息(AuthPermission)</h4>
                <article class="message is-primary">
                  <span class="icon has-text-primary">
                  <i class="fab fa-js"></i>
                  </span>
