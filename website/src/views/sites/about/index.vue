            ...
            <div class="columns">
              ...
              <div class="column is-6">
                ...
                <p class="control has-icon">
                  <input class="input is-large" type="text" value="" name="q"
              ...
              <div class="card">
                <div class="card-image">
                  <figure class="image profile-figure">
                    <img src="https://booknshelf.imgix.net/homepage/booknshelf-profile-showcase.png"
                         alt="Booknshelf Profile Homepage Showcase" class="profile-figure-image">
                    <div class="middle">
