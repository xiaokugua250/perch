    ...
    <body>
      <section class="hero is-info is-medium is-bold">
        ...
        <div class="hero-body">
          <div class="container has-text-centered">
            <h1 class="title">
              z-gour.com &lt;这个世界如此美好，值得人们为它奋斗，而我只同意后半句&gt;
      ...
      <div class="box cta">
        <p class="has-text-centered">
          <span class="tag is-primary">New</span> z-gour.com 是一个我也不知道要做什么的网站，如果大家有好想法欢迎一起来建设。
        </p>
      </div>
            ...
            <div class="control level-item">
              <a href="https://github.com/BulmaTemplates/bulma-templates">
                <div class="tags has-addons">
                  ...
                  <span class="tag is-info">powered by kugua</span>
                </div>
              </a>
            </div>
          </div>
