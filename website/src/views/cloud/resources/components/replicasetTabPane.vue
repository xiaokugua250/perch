<template>
  <div>
    ...
    <el-table :data="replicatset" border fit highlight-current-row style="width: 100%">
      <el-table-column
        v-loading="loading"
        align="center"
        label="ID"
...
import {getNodes, getReplicaset} from "@/api/cloud-resource";
...
export default {
  ...
  methods: {
    ...
    getCloudReplicaset(){
      ...
      getReplicaset(this.listQuery).then(response => {
        this. replicatset=response.spec
