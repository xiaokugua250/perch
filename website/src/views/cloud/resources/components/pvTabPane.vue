<template>
  <div>
    ...
    <el-table :data="pv" border fit highlight-current-row style="width: 100%">
...
import {getNodes, getPv} from "@/api/cloud-resource";
...
export default {
  ...
  methods: {
    ...
    getCloudPV(){
      ...
      getPv(this.listQuery).then(response => {
        this. pv=response.spec
