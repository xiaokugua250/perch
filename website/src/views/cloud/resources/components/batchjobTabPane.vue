<template>
  <div>
    ...
    <el-table :data="batchjob" border fit highlight-current-row style="width: 100%">
...
import {getBatchJob, getNodes} from "@/api/cloud-resource";
...
export default {
  ...
  methods: {
    ...
    getCloudBatchJob(){
      ...
      getBatchJob(this.listQuery).then(response => {
        this.batchjob=response.spec
