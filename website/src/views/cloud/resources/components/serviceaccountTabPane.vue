...
import {getServiceAccount} from "@/api/cloud-resource";
...
export default {
  ...
  methods: {
    ...
    getCloudServiceAccount(){
      ...
      getServiceAccount(this.listQuery).then(response => {
        this.serviceAccount=response.spec
