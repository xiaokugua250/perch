<template>
  <div>
    ...
    <el-table :data="configmap" border fit highlight-current-row style="width: 100%">
      <el-table-column
        v-loading="loading"
        align="center"
        label="ID"
...
import {getConfigmap, getNodes} from "@/api/cloud-resource";
...
export default {
  ...
  methods: {
    ...
    getCloudConfigmap(){
      ...
      getConfigmap(this.listQuery).then(response => {
        this.configmap=response.spec
