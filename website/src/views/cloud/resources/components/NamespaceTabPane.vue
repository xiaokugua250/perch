<template>
  <div>
    ...
    <el-table :data="namespaces" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column align="center" label="节点SPEC">
        <template slot-scope="scope">
...
import {getNamespaces} from "@/api/cloud-resource";
...
export default {
  ...
  methods: {
    ...
    getCloudNamespaces(){
      ...
      getNamespaces(this.listQuery).then(response => {
        this.namespaces=response.spec
